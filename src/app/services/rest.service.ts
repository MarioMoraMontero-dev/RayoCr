...
export class RestService {
  ...
  postNesSolicitud(token:string,Solicitud:any ): Observable<any>{
    ...
    return this.http.post<any>(endpoint+'apexrest/NewSolicitud',Solicitud,{headers: header2})
  }


  postlogin(token:string,login:any){
    const header2 = new HttpHeaders()
    .append("Content-Type","application/json")
    .append("Authorization","OAuth "+ token);
    return this.http.post<any>(endpoint+'apexrest/loginWS',JSON.stringify(login),{headers: header2})
  }


  postRenovacion(token:string,idC:String,pais:String,provincia:String,canton:String,distrito:String,direc:String){
    const header2 = new HttpHeaders()
    .append("Content-Type","application/json")
    .append("Authorization","OAuth "+ token);
    let json = '{"id":"'+idC+'","pais":"'+pais+'","provincia":"'+provincia+'","canton":"'+canton+'","distrito":"'+distrito+'","direccionExacta":"'+direc+'"}';
    return this.http.post<any>(endpoint+'apexrest/renovar/',json,{headers: header2})
  }
  ...
  postFinalizarProceso(token:string,jsonFinal:any){
    ...
    .append("Content-Type","application/json")
    .append("Authorization","OAuth "+ token);
    return this.http.post<any>(endpoint+'apexrest/finalizarProcesoWS/',JSON.stringify(jsonFinal),{headers: header2})
  }
  ...
  postRecuperarContra(token:string,emailUser:String){
    ...
    return this.http.post<any>(endpoint+'apexrest/recuperarPass/',json,{headers: header2})
  }
