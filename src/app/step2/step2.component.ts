...
export class Step2Component implements OnInit {
  ...
  public monto:number|undefined;
   ...
   comoNosConocieron:string[]=["Google","Facebook","Referido"];
    ...
    tiempoLaborado:string[]=["3 a 6 meses","6 a 12 meses","1 a 2 años","más de 2 años"];
    ...
    deseaRecibirMensajeria:string[] =["Desea recibir un mensajero","Envío de documentos en forma digital vía whatsApp","Firma presencial en Oficinas Centrales en San Jose Centro"];
...
open(name: string) {
  ...
  if(this.distrito == '-Seleccione un valor-' || this.provincia == '-Seleccione un valor-'  || this.canton == '-Seleccione un valor-'){
    ...
    modalSalida.componentInstance.mensaje2 = 'País , Provincia , Cantón y Distrito';
    modalSalida.componentInstance.mensaje3 = '';
    modalSalida.componentInstance.mensaje4 = '';
  }else{
  if(this.tamanoDocOrden >= 3676333){
    ...
    if(this.tamanoDocCedula >= 3676333){
      ...
      if(this.DeseaMensajeria == 'Desea recibir un mensajero' && this.DireccionDeEnvioValidator == ''){
        modalSalida.componentInstance.mensaje1 = 'Debe agregar una dirección de envió de la mensajería';
