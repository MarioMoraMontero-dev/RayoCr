...
export class StepDireccionComponent implements OnInit {
  ...
  constructor(private formBuilder:FormBuilder,public rest:RestService,private router: Router,private spinnerService:NgxSpinnerService,private _Activatedroute:ActivatedRoute) { }
...
"LAUREL"                  
  ...
  renovar(datos:any){
    ...
    this.rest.postRenovacion(this.token,IdCont!,this.direcCliente.pais,this.direcCliente.provincia,this.direcCliente.canton,this.direcCliente.distrito,this.direcCliente.direccionExacta).subscribe((data: {})=>{
      console.log(data);
